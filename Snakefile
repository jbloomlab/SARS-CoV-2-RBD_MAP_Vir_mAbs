...
rule make_summary:
    ...
    input:
        ...
        custom_plots='results/summary/custom-plots_Vir.md',
    output:
...
rule custom_plots:
    input:
        ...
        config['vir_annotations_input'],
        'custom-plots_Vir.Rmd'
    output:
        md='results/summary/custom-plots_Vir.md',
        md_files=directory('results/summary/custom-plots_Vir_files'),
        output1=config['vir_annotations_mds_input'],
        output2=config['vir_annotations_logo_input'],
    envmodules:
        'R/3.6.2-foss-2019b'
    params:
        nb='custom-plots_Vir.Rmd',
        md='custom-plots_Vir.md',
        md_files='custom-plots_Vir_files'
    shell:
        """
...
rule mds_escape_profiles:
    ...
    input:
        ...
        input_colors=config['vir_annotations_mds_input'],
    output:
