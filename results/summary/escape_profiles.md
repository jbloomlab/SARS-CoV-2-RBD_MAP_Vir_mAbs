...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/vir_antibodies_stackedlogo.pdf
     results/escape_profiles/vir_antibodies_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_2.png)
    ...
    Plotted profile 2 to:
     results/escape_profiles/vir_core_subset_stackedlogo.pdf
     results/escape_profiles/vir_core_subset_stackedlogo.png.
    
    Plotted profile 3 to:
     results/escape_profiles/vir_core_subset_color_by_bind_stackedlogo.pdf
     results/escape_profiles/vir_core_subset_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_4.png)
    ...
    Plotted profile 4 to:
     results/escape_profiles/vir_core_subset_color_by_expr_stackedlogo.pdf
     results/escape_profiles/vir_core_subset_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_6.png)
    ...
    Plotted profile 5 to:
     results/escape_profiles/vir_core_subset_sensitive_stackedlogo.pdf
     results/escape_profiles/vir_core_subset_sensitive_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_8.png)
    ...
    Plotted profile 6 to:
     results/escape_profiles/vir_core_subset_sensitive_color_by_bind_stackedlogo.pdf
     results/escape_profiles/vir_core_subset_sensitive_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_10.png)
    ...
    Plotted profile 7 to:
     results/escape_profiles/vir_core_subset_sensitive_color_by_expr_stackedlogo.pdf
     results/escape_profiles/vir_core_subset_sensitive_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_12.png)
    ...
    Plotted profile 8 to:
     results/escape_profiles/vir_RBM_subset_stackedlogo.pdf
     results/escape_profiles/vir_RBM_subset_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_14.png)
    ...
    Plotted profile 9 to:
     results/escape_profiles/vir_RBM_subset_color_by_bind_stackedlogo.pdf
     results/escape_profiles/vir_RBM_subset_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_16.png)
    ...
    Plotted profile 10 to:
     results/escape_profiles/vir_RBM_subset_color_by_expr_stackedlogo.pdf
     results/escape_profiles/vir_RBM_subset_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_18.png)
    ...
    Plotted profile 11 to:
     results/escape_profiles/vir_RBM_subset_sensitive_stackedlogo.pdf
     results/escape_profiles/vir_RBM_subset_sensitive_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_20.png)
    ...
    Plotted profile 12 to:
     results/escape_profiles/vir_RBM_subset_sensitive_color_by_bind_stackedlogo.pdf
     results/escape_profiles/vir_RBM_subset_sensitive_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_22.png)
    ...
    Plotted profile 13 to:
     results/escape_profiles/vir_RBM_subset_sensitive_color_by_expr_stackedlogo.pdf
     results/escape_profiles/vir_RBM_subset_sensitive_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_24.png)
    ...
    Plotted profile 14 to:
     results/escape_profiles/vir_antibodies_single_nt_stackedlogo.pdf
     results/escape_profiles/vir_antibodies_single_nt_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_26.png)
    ...
    Plotted profile 15 to:
     results/escape_profiles/s309_epitope_single_nt_stackedlogo.pdf
     results/escape_profiles/s309_epitope_single_nt_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_28.png)
    ...
    Plotted profile 16 to:
     results/escape_profiles/s309_epitope_single_nt_color_by_bind_stackedlogo.pdf
     results/escape_profiles/s309_epitope_single_nt_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_30.png)
    ...
    Plotted profile 17 to:
     results/escape_profiles/s309_epitope_single_nt_color_by_expr_stackedlogo.pdf
     results/escape_profiles/s309_epitope_single_nt_color_by_expr_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_32.png)
    ...
    Plotted profile 18 to:
     results/escape_profiles/s2e12_epitope_single_nt_stackedlogo.pdf
     results/escape_profiles/s2e12_epitope_single_nt_stackedlogo.png.
...
![png](escape_profiles_files/escape_profiles_26_34.png)
    ...
    Plotted profile 19 to:
     results/escape_profiles/s2e12_epitope_single_nt_color_by_bind_stackedlogo.pdf
     results/escape_profiles/s2e12_epitope_single_nt_color_by_bind_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_36.png)
    


    
    Plotted profile 20 to:
     results/escape_profiles/s2e12_epitope_single_nt_color_by_expr_stackedlogo.pdf
     results/escape_profiles/s2e12_epitope_single_nt_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_38.png)
    


    
    Plotted profile 21 to:
     results/escape_profiles/s2d106_epitope_single_nt_stackedlogo.pdf
     results/escape_profiles/s2d106_epitope_single_nt_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_40.png)
    


    
    Plotted profile 22 to:
     results/escape_profiles/s2d106_epitope_single_nt_color_by_bind_stackedlogo.pdf
     results/escape_profiles/s2d106_epitope_single_nt_color_by_bind_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_42.png)
    


    
    Plotted profile 23 to:
     results/escape_profiles/s2d106_epitope_single_nt_color_by_expr_stackedlogo.pdf
     results/escape_profiles/s2d106_epitope_single_nt_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_44.png)
    


    
    Plotted profile 24 to:
     results/escape_profiles/s2X259_stackedlogo.pdf
     results/escape_profiles/s2X259_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_46.png)
    


    
    Plotted profile 25 to:
     results/escape_profiles/s2X259_color_by_bind_stackedlogo.pdf
     results/escape_profiles/s2X259_color_by_bind_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_48.png)
    


    
    Plotted profile 26 to:
     results/escape_profiles/s2X259_color_by_expr_stackedlogo.pdf
     results/escape_profiles/s2X259_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_50.png)
    


    
    Plotted profile 27 to:
     results/escape_profiles/s2X259_single_nt_stackedlogo.pdf
     results/escape_profiles/s2X259_single_nt_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_52.png)
    


    
    Plotted profile 28 to:
     results/escape_profiles/s2X259_single_nt_color_by_bind_stackedlogo.pdf
     results/escape_profiles/s2X259_single_nt_color_by_bind_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_54.png)
    


    
    Plotted profile 29 to:
     results/escape_profiles/s2X259_single_nt_color_by_expr_stackedlogo.pdf
     results/escape_profiles/s2X259_single_nt_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_56.png)
    


    
    Plotted profile 30 to:
     results/escape_profiles/all_antibodies_stackedlogo.pdf
     results/escape_profiles/all_antibodies_stackedlogo.png.



    
![png](escape_profiles_files/escape_profiles_26_58.png)
